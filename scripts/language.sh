...
LOCALE_DIR="stage3/05-install-pwnagotchi/files/pwnagotchi/pwnagotchi/locale"
VOICE_FILE="stage3/05-install-pwnagotchi/files/pwnagotchi/pwnagotchi/voice.py"
